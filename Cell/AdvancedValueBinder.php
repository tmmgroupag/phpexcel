...
class AdvancedValueBinder extends DefaultValueBinder implements IValueBinder
{
    ...
    public function bindValue(\PHPExcel\Cell $cell, $value = null)
    {
        ...
        if (is_string($value)) {
            $value = \PHPExcel\Shared\StringClass::SanitizeUTF8($value);
        }
        ...
        if ($dataType === DataType::TYPE_STRING && !$value instanceof \PHPExcel\RichText) {
            ...
            $decimalSeparator = \PHPExcel\Shared\StringClass::getDecimalSeparator();
            $thousandsSeparator = \PHPExcel\Shared\StringClass::getThousandsSeparator();
