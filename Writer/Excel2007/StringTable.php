...
class StringTable extends WriterPart
{
        ...
        if ($pStringTable !== null) {
            ...
            foreach ($pStringTable as $textElement) {
                ...
                if (! $textElement instanceof \PHPExcel\RichText) {
                    $textToWrite = \PHPExcel\Shared\StringClass::ControlCharacterPHP2OOXML($textElement);
    ...
    public function writeRichText(\PHPExcel\Shared\XMLWriter $objWriter = null, \PHPExcel\RichText $pRichText = null, $prefix = null)
    {
        ...
        foreach ($elements as $element) {
            ...
            $objWriter->writeAttribute('xml:space', 'preserve');
            $objWriter->writeRawData(\PHPExcel\Shared\StringClass::ControlCharacterPHP2OOXML($element->getText()));
            $objWriter->endElement();
