...
class Autoloader
{
    ...
    public static function load($className)
    {
        ...
        if (is_int(strpos($className, 'PHPExcel_'))) {
        	
  
        	$namespaceClassName = str_replace("_","\\", $className);
        	class_alias($namespaceClassName,$className);
        	//require($namespaceClassName);
