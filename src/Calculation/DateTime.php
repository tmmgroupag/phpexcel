...
class DateTime
{
    ...
    public static function DATE($year = 0, $month = 1, $day = 1)
    {
        ...
        $year = ($year !== null) ? \PHPExcel\Shared\StringClass::testStringAsNumeric($year) : 0;
        $month = ($month !== null) ? \PHPExcel\Shared\StringClass::testStringAsNumeric($month) : 0;
        $day = ($day !== null) ? \PHPExcel\Shared\StringClass::testStringAsNumeric($day) : 0;
        if ((!is_numeric($year)) ||
            (!is_numeric($month)) ||
            (!is_numeric($day))) {
            return Functions::VALUE();
